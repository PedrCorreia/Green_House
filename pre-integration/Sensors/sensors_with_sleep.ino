...
void setup() {
  ...
  // delay 0.1s to make the ESP32 and the sensors stabilize the voltage.
  delay(100);
  ...
  // wait for 1s before sleeping.
  delay(1000);
  Serial.printf("Data sending completed! The node will start to deep sleep for %d s", SLEEP_TIME);
